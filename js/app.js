...
function calcularIndicadores(){
    ...
    //codigo para incluir los valores de los indicadores en browser
    ...
    //codigo para darle estilo a las barras de los indicadores
    ...
    //codigo para incluir imagenes de balance de lupulo
...
function limpiarCampos (){
    ...
    //-----------------------------------------------------//
    //codigos para limpiar valores y barras de indicadores//
    //---------------------------------------------------//
    ...
    const indicadorOg = document.querySelector(".indicador-og");
    indicadorOg.style.width = 0;
    indicadorOg.style.height = 0;

    const indicadorFg = document.querySelector(".indicador-fg");
    indicadorFg.style.width = 0;
    indicadorFg.style.height = 0;
    ...
    const indicadorAbv = document.querySelector(".indicador-abv");
    indicadorAbv.style.width = 0;
    indicadorAbv.style.height = 0;
    ...
    //-------------------------------------------------//
    //----Codigos para limpiar arrays y variables-----//
    //-----------------------------------------------//

    arrayLibrasLimpieza = arrayLibras.splice(0);
    arrayExtractoLimpieza = arrayExtracto.splice(0);
    arrayDensidad = [];
    arrayMcu = [];
    srm = 0;
    arraySrmLimpieza = arraySrm.splice(0);
    arrayOnzasLimpieza = arrayOnzas.splice(0);
    arrayTiempoLimpieza = arrayTiempo.splice(0);
    arrayAALimpieza = arrayAA.splice(0);    
    arrayMinutosLimpieza = arrayMinutos.splice(0);
    arrayIbu = [];
    densidadFinal = 0;
    levaduraAtenuacion = 0;
    abv = 0;
